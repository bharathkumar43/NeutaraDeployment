...
export type DeploymentStatus = 'draft' | 'pending_qa_approval' | 'qa_approved' | 'rejected_by_qa' | 'pending_infra_deployment' | 'deployment_in_progress' | 'deployment_completed' | 'deployment_failed' | 'pending_dev_acknowledgment' | 'successfully_completed' | 'issue_raised';
