...
export const InfraDeploymentPage: React.FC = () => {
  ...
  const [modalType, setModalType] = useState<'start' | 'complete' | null>(null);
  ...
  const closeModal = () => { setSelectedDep(null); setModalType(null); setPreviewUrl(null); setUploadFile(null); };
